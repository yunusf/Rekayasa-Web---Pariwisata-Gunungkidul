					...
					<div class="card-body">
						...
						<form action="<?php echo site_url('admin/berita/add') ?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama') ? 'is-invalid' : '' ?>" type="text" name="nama" placeholder="Berita" />
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('deskripsi') ? 'is-invalid' : '' ?>" name="deskripsi" placeholder="Deskripsi Berita..."></textarea>
								<div class="invalid-feedback">
